...
<template>
  <div class="Login flex colu">
    ...
    <p class="ml15 fz16 mt10"><span class="colore5">*</span>&nbsp;注册类型</p>
    <van-field v-model="typeName" placeholder="请选择注册类型" @click="typeShow = true" readonly class="fz16">
      <template #button>
        <span class="color259">选择</span>
      </template>
    </van-field>
...
export default {
  ...
  data() {
    return {
      ...
      sexShow:false,
      typeName:'',
      typeArr:[{name:'患者本人',id:1},{name:'患者家属',id:2}],
      typeShow:false,
  ...
  methods: {
    ...
    submit(){ 
      ...
      this.$http.saveApi(val).then((res) => {
